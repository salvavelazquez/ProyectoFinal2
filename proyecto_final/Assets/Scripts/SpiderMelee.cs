...
public class SpiderMelee : MonoBehaviour
{
    ...
    public float cronometro; // cronometro para el tiempo entre rutinas
    ...
    public void ComportamientoEnemigo()
    {
        ...
        {
            cronometro += 1 * Time.deltaTime; // cronometro sumando tiempo
            if (cronometro >= 4) // if para cuando el cronometro llegue a 4
            {
            ...
            {
                case 0:
                    // caso 0 es para que se quede quito
                    break;
                case 1:
                ...
                case 2:
                    ...
                    transform.Translate(Vector3.forward * 1 * Time.deltaTime); // se moverá hacia adeltane con una velocidad de 1
                    break;
            }
        }
        else
        {
            if (Vector3.Distance(transform.position, target.transform.position) > 1)
            {
                ...
                transform.Translate(Vector3.forward * 2 * Time.deltaTime); // se desplaza hacia adeltante con una velocidad de 2
            }
        }
    }
